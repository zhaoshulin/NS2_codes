...
# 註解: A DS-RED script that uses CBR traffic agents and the SRTCM Policer.
...
#設定第一個分組的CIR為1500000 bps, CBR為2000 bytes, EBS為3000bytes
#設定第二個分組的CIR為1000000 bps, CBR為1000 bytes, EBS為2000bytes
